...
import me.zcd.music.napster.api.resources.ArtistResultsResourceHackContainer.ArtistResultsResourceMultipleResults;
import me.zcd.music.napster.api.resources.ArtistResultsResourceHackContainer.ArtistResultsResourceSingleResult;
...
public class ArtistSearch {
	...
	public List<String> findArtistNames(String name) {
		try {
			...
			log.severe("UTF-8 encoding not supported by URLencoder!!!!");
			return null;
		}
